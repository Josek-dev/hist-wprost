...
<main id="container">
    <article class="hotnews" id="article-1">
        ...
        <section class="left-transparency"></section>
    </article>
    ...
    <article class="hotnews" id="article-6">
        <section class="right-transparency"></section>
        <section class="description"><a href="#">
                <h3>Rzeź Woli była największą masakrą cywili podczas II wojny światowej</h3>
                <p>W pierwszych dniach Powstania Warszawskiego doszło do&nbsp;eksterminacji cywili w&nbsp;dzielnicy Wola. Szczyt masakry trwał w&nbsp;dniach 5-7 sierpnia 1944&nbsp;r. Równolegle w&nbsp;innej warszawskiej dzielnicy dochodziło do&nbsp;fali masowych pogromów, grabieży i&nbsp;gwałtów, które zyskały miano rzezi Ochoty.</p>
            </a>
    ...
    <section id="page-box">
        <h2 id="page-box-title">WIĘCEJ HISTORII...</h2>
        <article id="news-1" class="page-news">
    ...
    <div id="jqpopup">
        <div id="loglog">
            ...
            <div id="signin">
                <form method="post" action="login.php" name="logform" onsubmit="return validate();">
                    <label for="nickname">
                        <span class="label">Login</span>
                        <input id="nickname" type="text" name="nickname" placeholder="Wpisz login">
                    </label>
                    <label for="password">
                        <span class="label">Hasło</span>
                        <input type="password" name="password" id="password" placeholder="Wpisz hasło">
                    </label>
                    <button id="submit" type="submit" name="submit">Zaloguj</button>
                </form>
            </div>
        </div>
    </div>
